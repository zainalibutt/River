...
| 2026-09-02 | F3A source iris detail | Codex | `0a7941d` | Replaced the single-colour iris treatment with a 128px crop of the existing native brown-eye texture and reduced the fitted disc to the measured eye opening. Rooftop-only rebuild: 57,862 triangles, 30 materials, 46 draw calls and 6,097 KB; Chrome close view preserves a smaller pupil and visible brown iris without a River application error. |
| 2026-09-06 | Silver male in the Rooftop | Astra | `7b66994`..`8e4c17a` | Source builder, seated bake, scale measured against the furniture, solved rail contact, authored arms and an additive idle over nine clips. The published Rooftop carries one skin over 137 joints and nine clips - the first venue with a rig in it |
| 2026-09-06 | Dusk sky on the menu and in the room | Claude | `409662d`, `3ed7377` | A menu still regenerated from the venue, and a gradient dome in the Rooftop keyed by venue so interiors keep a flat colour |
| 2026-09-07 | Silver hair conform, shipped | Astra, shipped by Claude | `d6ab627` | The conform no longer buries the occiput; the venue was rebuilt end to end with the back of the head covered, structurally the same room |
| 2026-09-08 | Clipping budget gate | Claude | `b508617` | The triangle-intersection check runs from npm and holds a measured budget per surface, so penetration cannot get worse without a diff saying so |
| 2026-09-10 | Silver standing black tie, A11 | Astra | proof only | Authored black-tie wardrobe through repair, a 40,000-triangle budget and a light and material finish. Accepted by Zain as the standing state |
| 2026-09-10 | Silver seated default pose, A22 | Astra | proof only | A seated state of its own with the shoulders covered. Accepted by Zain as the base to pose from |
| 2026-09-10 | HUD action surface and material | Claude | `26f7b1a`..`dece0f0` | Raise sizing against the pot, a measured layout harness, the action ring the anatomy describes, card size, lit brass material, seat furniture on the seats. Merged 13 Sep after Zain looked at it |
| 2026-09-12 | Amber seated proof | DeepSeek | `e174b5b`..`edd40b5` | An isolated seated character from `build_native_amber.py`, legible at gameplay distance; its report names the open collar and deltoid items |
| 2026-09-13 | Character pose by hand | Zain | proof only | A38b worked directly in Blender. Character pose and fit move from lane passes to hand-authoring with the models assisting; see DECISIONS |
| 2026-09-13 | Repository sanitising and record catch-up | Claude | `dfa46f5`..HEAD | Unpushed history reshaped to what landed, laws and character packets out of the tree, one mailmapped author, a local-path gate, and the record brought up to the silver male and Amber |
