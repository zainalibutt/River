...
- Betting order is standard. With two players dealt in, the button posts the small blind, acts first before the flop and last after it, and the big blind keeps its option after a limp. An all-in for less than a full raise must still be called or folded to, but does not reopen raising for players who have already acted.
...
- Named bots remember their own encounters with a signed-in human across sessions. They do not share private reads with other bots. Anonymous population statistics may seed a cold-start prior. Unrevealed cards never become labelled bluff or value evidence. Each bot's memory of a player is folded once a day into a single summary, so it stays small however often they meet.
