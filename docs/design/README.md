...
| [`17-acceptance-5bc.md`](17-acceptance-5bc.md) | Character pipeline review. One P0 — the garment does not deform | 2026-08-24 |
| [`16-phase4-contract.md`](16-phase4-contract.md) | Timers, the fairness rework, economy and ledger rules, social systems, REP. **Contains a security defect** | 2026-08-24 |
