...
GOLD_FEMALE_IDENTITY = (
    ('head-oval', 0.70),
    ('head-invertedtriangular', 0.66),
    ('forehead-temple-incr', 0.18),
    ('l-eye-scale-incr', 0.02),
    ('r-eye-scale-incr', 0.02),
    ('l-eye-height1-decr', 0.22),
    ('r-eye-height1-decr', 0.22),
    ('l-eye-eyefold-up', 0.06),
    ('r-eye-eyefold-up', 0.06),
    ('l-eye-corner2-up', 0.10),
    ('r-eye-corner2-up', 0.10),
    ('l-cheek-bones-incr', 0.38),
    ('r-cheek-bones-incr', 0.38),
    ('l-cheek-volume-incr', 0.10),
    ('r-cheek-volume-incr', 0.10),
    ('nose-scale-horiz-decr', 0.50),
    ('nose-scale-vert-incr', 0.24),
    ('nose-point-width-decr', 0.36),
    ('nose-scale-depth-decr', 0.12),
    ('mouth-scale-horiz-decr', 0.10),
    ('mouth-cupidsbow-incr', 0.36),
    ('mouth-upperlip-volume-incr', 0.28),
    ('mouth-lowerlip-volume-incr', 0.34),
    ('mouth-angles-up', 0.12),
    ('chin-width-decr', 0.68),
    ('chin-height-incr', 0.08),
